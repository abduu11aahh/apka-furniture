...
import 'package:Apka_Furniture/presentation/bidding_screen_one_page_seller/bidding_screen_one_page.dart';
import 'package:Apka_Furniture/presentation/bidding_screen_two_page_seller/bidding_screen_two_page.dart';
...
class BiddingScreenSeller extends StatefulWidget {
  const BiddingScreenSeller({Key? key}) : super(key: key);
...
class CartScreenState extends State<BiddingScreenSeller>
          ...
          child: Column(children: [
            ...
            SizedBox(
                ...
                child: TabBarView(controller: tabviewController, children: [
                  BiddingScreenSellerOnePage(),
                  BiddingScreenSellerTwoPage()
                ])),
            SizedBox(height: 23.v),
          ]),
        ),
  ...
  Widget _buildTabview(BuildContext context) {
    return Container(
        ...
        child: TabBar(
            ...
            dividerHeight: 5.v,
            tabs: [
              Tab(child: Text('My Bids')),
              Tab(child: Text('Confirmed Orders'))
            ]));
  }
